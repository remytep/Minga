                ...
                <div className="flex flex-col items-center w-48 h-full mr-5 py-2 overflow-hidden text-gray-700 bg-[#C9C5BA] rounded">
                    ...
                    <div className="w-full px-2">
                        <div className="flex flex-col items-center w-full mt-3 border-t border-gray-300">
                            ...
                            <div onClick={() => setIsDesktop(!isDesktop)} className="flex items-center w-full h-12 px-3 mt-2 rounded hover:bg-slate-100 cursor-pointer">
                                <h2 className="ml-2 text-sm font-medium">Desktop</h2>
                            </div>
                            <div onClick={() => setIsLshape(!isLshape)} className="flex items-center w-full h-12 px-3 mt-2 hover:bg-slate-100 rounded cursor-pointer">
