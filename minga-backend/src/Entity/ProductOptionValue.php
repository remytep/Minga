...
class ProductOptionValue
{
    ...
    #[Groups(['product_option_value.read', 'product_option.item.get', 'product_option.read', 'product.read', 'product.write',  'product_option.write', 'sku_value.read', 'sku.read', 'order.read'])]
