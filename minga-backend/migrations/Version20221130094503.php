 ...
 */
final class Version20221130094503 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE sku_values (id INT AUTO_INCREMENT NOT NULL, product_id INT NOT NULL, sku_id INT DEFAULT NULL, product_option_id INT DEFAULT NULL, product_option_value_id INT DEFAULT NULL, INDEX IDX_9A8AA27B4584665A (product_id), INDEX IDX_9A8AA27B1777D41C (sku_id), INDEX IDX_9A8AA27BC964ABE2 (product_option_id), INDEX IDX_9A8AA27BEBDCCF9B (product_option_value_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
